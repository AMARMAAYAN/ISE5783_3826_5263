...
//        for (int i = 0; i < 4; i++) {
//            for (int j = 0; j < 2; j++) {
//                scene.getGeometries().add(new Sphere(new Point(ballHolderX + 25 + 50 * i, ballHolderY - 25 - 50 * j, ballHolderZ + 80), 20)
//                        .setEmission(randomColor()).setMaterial(new Material().setShininess(25).setKs(1).setKd(0.45).setKr(0.35)));
//                scene.getGeometries().add(new Sphere(new Point(ballHolderX + 25 + 50 * i, ballHolderY - 25 - 50 * j, ballHolderZ + 20), 20)
//                        .setEmission(randomColor()).setMaterial(new Material().setShininess(25).setKs(1).setKd(0.45).setKr(0.35)));
//            }
//        }
//        scene.getGeometries().add(bottomBallHolder, topBallHolder);
//    }
...
//        scene.getGeometries().add(bowlingPin1, bowlingPin2, bowlingPin3, bowlingPin4, bowlingPin5, bowlingPin6);
//
//    }
...
//        scene.getGeometries().add(bowlingPin1, bowlingPin2, bowlingPin3, bowlingPin4, bowlingPin5, bowlingPin6,ball);
//    }
...
//    }
    ...
    void createTexture(Ray ray)//it goes from right to left
    {
        for (int i = 0; i < 22; i++) {
            for (int j = 0; j < 5; j++) {
                scene.getGeometries().add(new Polygon(new Point(ray.getP0().getX(), ray.getP0().getY() + 15 + 30 * i, ray.getP0().getZ() + 30 * j), new Point(ray.getP0().getX(), ray.getP0().getY() + 30 * i, ray.getP0().getZ() + 15 + 30 * j), new Point(ray.getP0().getX(), ray.getP0().getY() + 15 + 30 * i, ray.getP0().getZ() + 30 + 30 * j), new Point(ray.getP0().getX(), ray.getP0().getY() + 30 + 30 * i, ray.getP0().getZ() + 15 + 30 * j))
    ...
    public static class BowlingPin extends Intersectable {
        ...
        protected List<GeoPoint> findGeoIntersectionsHelper(Ray ray) {
            return _spheres.findGeoIntersections(ray);
        }
...
//
////        public BowlingPin setBvhIsOn(boolean bvhIsOn) {
////            if (!_bvhIsOn && bvhIsOn) {
////                createBoundingBox();
////            }
////            _bvhIsOn = bvhIsOn;
