...
public class IntegrationTests {
    private Scene _scene = new Scene.SceneBuilder("Test scene").build();
    ...
    public void noImprovements() {
        ...
        _scene.setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.15)));

        _scene.getGeometries().add( //
        ...
        _scene.getGeometries().setBvhIsOn(false);
        _scene.getLights().add(new SpotLight(new Color(700, 400, 400), new Point(60, 50, 0), new Vector(0, 0, -1)) //
    ...
    public void adaptiveSSWithBVH() {
        ...
        _scene.getGeometries().setBvhIsOn(true);
        _scene.getLights().add(new SpotLight(new Color(700, 400, 400), new Point(60, 50, 0), new Vector(0, 0, -1)) //
                .setKl(4E-5).setKq(2E-7));
