...
public class BVHTests {
    ...
    public void tryNoBVH() {
        ...
        _scene.setAmbientLight(new AmbientLight(new Color(WHITE),new Double3(0.1)));
        _scene.getLights().add(new PointLight(new Color(LIGHT_GRAY),new Point(50,50,50)));
        _scene.getLights().add( //
